  ...
  return (
    <section className='ml-4 mr-4 lg:ml-64 mt-20'>
      ...
      <div className="rounded bg-blue-900 bg-opacity-50 p-2 mb-2 text-white flex items-center space-x-2">
        ...
        <p>As of now, you <span className="underline italic">must be signed</span> and <span className="underline italic">also be authorized</span> by an administrator to access core features of <span className="underline italic">The Ocean Scout</span>.</p>
      </div>
    </section>
  )
}